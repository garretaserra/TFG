...
\begin{overview}{1cm}
Nowadays everyone knows what Bluetooth is, but few people understand that Bluetooth is based on two different technologies. This paper will explain Bluetooth Low Energy (BLE) and how it is used very efficiently in mobile devices.
\newline
\newline
...
\newline
\newline
The main goal of this work is to explain deeply and with detail BLE and give the necessary information to be able to develop a simple but real implementation of the protocol. 
...
There will be a step by step tutorial with the SimpleLink environment to develop a project from scratch using the chip.
