...
En l'administrador de dispositius de Windows es poden trobar els ports utilitzats per la placa i els paràmetres de la conexió els indica Texas Instruments\cite{serial_params}.
...
S'enviaran notificacions a aquells dispositius que escriguin un 1 o Inicacions als que escriguin un 2.
