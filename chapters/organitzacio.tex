...
\subsection{Btool}
L'aplicació BTool utilitza l'API de Host Test per executar les crides a les diferents capes BLE.
Primer de tot, BTool necessita saber per quina interfície ha d'interactuar amb la placa.
Al administrador de dispositius de Windows es poden trobar els ports utilitzats per la placa i els paràmetres de la comunicació els indica Texas Instruments %TODO afegir referencia
...
I també es pot veure si es reben notificacions a través de la consola.
