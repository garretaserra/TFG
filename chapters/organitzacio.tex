...
Al analitzar els atributs es pot veure com primer hi ha la definició del servei de LEDs i just després hi ha les declaracions de característiques del LED0 i LED1 amb els seus corresponents valors.
Posteriorment hi ha la declaració del servei dels botons amb les corresponents característiques.
