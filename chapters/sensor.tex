...
Els resultats obtinguts indiquen que la distància màxima d'abast del dispositiu en una capa M2 és de 75 metres, mentre que en una capa S=8 aquesta distància s'extén fins els 135.
...
Per provar el funcionament de l'EnergyTrace s'ha utilitzat durant l'execució en el xip del Project Zero. A continuació, es pot observar una captura d'un segon de duració del consum aproximat de corrent.
...
Un cop s'estableix una connexió amb el dispositiu es realitza una altre captura d'un segon que es pot observar a continuació.
...
A continuació es pot observar aquesta implementació real del circuit.
...
Les connexions des del circuit fins la placa es fan a través dels ports que proporciona la placa a la seva part de darrera.
...
Un cop fetes les conexions, cal executar el codi de la placa i clicar el botó d'escanejar de l'aplicació.
