...
\subsubsection{LE 2M}
En la versió de Bluetooth 5 permet a la capa física operar a 2 Msimbols/s enlloc dels 1 Ms/s que es podia anteriorment en la versió 4.0. L'augment de la velocitat dels símbols permet augmentar la quantitat de dades que es poden transmetre a nivell d'aplicació.
