...
La potència màxima de transmissió és de 20 dBm (100 mW) segons la especificació\footnote{La placa utilitzada pot transmetre fins a 5 dBm de potència}.
Però 
...
\subsection{Host}
BLE es va dissenyar amb la flexibilitat en ment, és per això que l'estructura de la pila del host permet no utilitzar certes capes que es consideren opcionals.
...
%TODO:Repasar capes ja qu es'ha canviat la imatge
...
\subsubsection{SM \textit{Security Manager}}
La capa SM proveeix de diferents serveis relacionats amb la seguretat de la connexió.
...
La condició que ha de complir l'UUID és que no sigui XXXXXXXX-0000-1000-8000-00805F9B34FB ja que aquest sufix correspon als que estan reservats segons l'estàndard.
