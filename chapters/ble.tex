...
\end{table}
\footnotetext[1]{Les bandes indicades com a 900 MHz varien depenent del país des de 800 MHz fins a 1000 MHz}
...
\subsection{Host}
El protocol BLE es va dissenyar amb la flexibilitat en ment, és per això que l'estructura de la pila del host permet no utilitzar certes capes que es consideren opcionals.
