...
Aquest desenvoluapment va culminar l'any 2004 amb la publicació de la \textit{Bluetooth Low End Extension} \cite{Original_BLE_Extension}. 
Posteriorment, es va dur a terme múltiples millores juntament amb Logitech en el projecte d'investigació per part de la Unió Europea MIMOSA \cite{MIMOSA}. El resultat del projecte es va anunciar al 2006 amb el nom de Wibree.
...
\subsection{Altres MANETS}
 BLE és una de les MANETs més imporatnts però n'hi ha d'altres que competeixen i que s'analitzaran a continuació.
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{rccccccc}
			\multicolumn{1}{l}{}    & BLE 4                                                  & BLE 5   & 6LoWPAN & Zigbee      & Z-Wave      & Insteon & LoRa            \\
			Abast (m)               & 50                                                     & 200     & 100     & 100         & 90          & 120     & 10Km            \\
			Velocitat Física (Kbps) & 1000                                                   & 2000    & 250     & 250         & 100         & 4,5     & 27              \\
			Tasa de dades (Kbps)    & \begin{tabular}[c]{@{}c@{}}300\\ 4.2: 800\end{tabular} & 1430    & 162     & 162         & 40          & 2,8     & 5               \\
			Consum                  & 15                                                     & 15      & 15      & 30          & 23          &         & 18              \\
			Banda                   & 2.4 GHz                                                & 2.4 GHz & ISM     & 800-900 MHz & 800-900 MHz & 915 KHz & 400/800-900 MHz
		\end{tabular}
	}
\end{table}
...
Amb els diferents esquemes s'utilitza una taxa de codi diferent que pot augmentar la capacitat de correcció i augmentar el abast però disminuir la quantitat de dades que es poden transmetre.
...
La pila pròpia de Bluetooth Low Energy esta dividida en dues parts, el controlador i el \textit{host}. Aquestes dues parts són independents i utilitzen el protocol \textit{Host Controller Interface} (HCI d'ara endavant) per comunicar-se entre si.
...
Es comentaran en un exemple real més endavant. %TODO: afegir link dinamic
...
\begin{figure}[!h]
	\begin{center}
		\begin{subfigmatrix}{1}
			\subfigure[Títol subfigura 1]{\includegraphics[width=0.8\textwidth]{./images/scanning_diagram}}
			\subfigure[Títol subfigura 1]{\includegraphics[width=0.8\textwidth]{./images/scanduationperiod}}
		\end{subfigmatrix}
	\end{center}
\end{figure}
...
\begin{figure}[!h]
	\begin{center}
		\begin{subfigmatrix}{1}
			\subfigure[Format PDU d'anunci]{\includegraphics[width=0.8\textwidth]{./images/Packet_format_4_2_adv.png}}
			\subfigure[Format PDU de dades]{\includegraphics[width=0.8\textwidth]{./images/Packet_format_4_2_data.png}}
		\end{subfigmatrix}
	\end{center}
\end{figure}
