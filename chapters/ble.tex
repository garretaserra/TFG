...
Hi ha diferents tipus de xarxes segons quin rol prenen els nodes que en formen part.
Quan els dispositius només són o esclaus o mestres, les connexions s'estableixen 1:N és a dir un mestre pot estar connectat a més d'un esclau però un esclau només estarà connectat a un mestre.
En aquest cas el que s'haurà format serà una xarxa \textit{piconet}.
Abans del perfil de malla totes les xarxes eren \textit{piconets}.

Gràcies al nou perfil un node pot ser mestre en una connexió i esclau en una altre. D'aquesta manera els nodes formen connexions N:M, és a dir, un mateix node pot estar connectat amb esclaus i mestres a la vegada.
Aquest tipus de xarxa s'anomena \textit{scatternet}.
