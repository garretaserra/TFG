...
\begin{figure}[!h]
	\begin{center}
		\begin{subfigmatrix}{1}
			\subfigure[Escaneig de canals]{\includegraphics[width=0.8\textwidth]{./images/scanning_diagram}}
			\subfigure[Periodes de escaneig]{\includegraphics[width=0.8\textwidth]{./images/scanduationperiod}}
		\end{subfigmatrix}
	\end{center}
...
En la figura \ref{fig:unicast_roles} es pot veure el procediment en que dos dispositius estableixen una connexió.
Tenim el dispositiu A que inicialment està coma observador i el dispositiu B que s'està anunciant.
Cal recordar que els anuncis no es detecten tots ja que els dispositius no sempre estan transmetent i escoltant en el mateix canal.
...
Quant s'utilitza aquest paràmetre permet tenir una connexió amb una latència baixa pero amb un consum igualment reduït mentre no s'haguin de transmetre dades molt sovint.
