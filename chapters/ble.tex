...
La especificació de BLE 5 anomena el procés d'escanejar com a \textit{Device Descovery} i es basa en dos tipus, el escaneig actiu i el passiu.
...
\begin{figure}
	\begin{center}
		%\begin{subfixmatrix}{2}
			%\subfigure[Títol subfigura 1]{\includegraphics{./setup/EETAC-positiu-negre}
			%\subfigure[Títol subfigura 1]{\includegraphics{./setup/EETAC-positiu-negre}
		%\end{subfixmatrix}
	\end{center}
\end{figure}